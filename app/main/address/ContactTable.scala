...
class ContactTable extends Table {
  ...
  override val primaryKey = id :: Nil

  /** カラム定義をリストで返す */
  override def unapplySeq: Option[Seq[Column]] = Some(Seq(id, firstName, lastName, email, phone, deleted))
  
  /** 削除フラグを取得します */
  override def deleteFlag: Column = deleted
